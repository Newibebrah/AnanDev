...
const slides = [
  {
    ...
    cta: (
      <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
        <Button asChild size="lg" className="rounded-full px-8 w-full sm:w-auto min-h-[44px]">
    ...
    content: (
      <div className="flex flex-col md:flex-row items-center gap-6 md:gap-8 max-w-2xl mx-auto text-center md:text-left">
        <div className="shrink-0">
          <div className="w-28 h-28 md:w-44 md:h-44 rounded-2xl bg-gradient-to-br from-primary to-blue-500 p-1 mx-auto md:mx-0">
  ...
  },
  {
    ...
    cta: (
      <div className="flex items-center justify-center">
        <Button asChild size="lg" className="rounded-full px-8 min-h-[44px]">
